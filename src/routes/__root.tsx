...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "EditVault — Secure Escrow for Video Editors" },
      { property: "og:description", content: "Clients deposit funds upfront. Editors get paid automatically after delivery." },
